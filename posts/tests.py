...
class PostDetailViewTests(APITestCase):
    def setUp(self):
        ...
        bob = User.objects.create_user(username='bob', password='pass2')
        Post.objects.create(
            owner=adam, title='a title', content='adams content'
        )
        Post.objects.create(
            owner=bob, title='a second title', content='bobs content'
        )
    ...
    def test_user_cant_retrieve_invalid_id(self):
